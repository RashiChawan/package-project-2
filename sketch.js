...
function setup() {
	...
	centerBox=createSprite(boxPosition+100,boxY+40,200,20);
	centerBox.shapeColor=color(255,0,0);

	centerBody=Bodies.retangle(boxPosition+100,boxY+45-20,200,20,{isStatic:true})
	World.add(world,centerBody);

	rightBox=createSprite(boxPosition+200,boxY+40,20,100);
